...
const SVGRight =()=> {
  return (
    <svg height="21" viewBox="0 0 11 20" width="20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><polygon points="2.9 18.5 1.5 17.1 8.5 10 1.4 2.9 2.8 1.5 11.3 10"></polygon></svg>
  );
};
const SVGLeft =()=> {
  return (
